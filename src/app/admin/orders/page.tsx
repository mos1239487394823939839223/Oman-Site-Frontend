        ...
        <main className="flex-1 p-4 lg:p-8">
          ...
          <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <h1 className="text-3xl font-black text-[#1F2937]">إدارة الطلبات</h1>
              <p className="text-gray-400 mt-1 text-sm">عرض وإدارة جميع طلبات العملاء</p>
            </div>
            <button
              onClick={fetchData}
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#5C2E3A] text-white rounded-xl font-bold text-sm hover:bg-[#4A2330] transition-colors shadow-md"
            >
              ↻ تحديث القائمة
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex items-center gap-4">
              ...
              <div>
                <p className="text-xs text-gray-400 font-bold tracking-wider">إجمالي الطلبات</p>
                <p className="text-2xl font-black text-[#1F2937]">{orders.length}</p>
              </div>
            </div>
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-yellow-50 flex items-center justify-center text-xl">⏳</div>
              <div>
                <p className="text-xs text-gray-400 font-bold tracking-wider">قيد الانتظار</p>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 flex items-center gap-4">
              ...
              <div>
                <p className="text-xs text-gray-400 font-bold tracking-wider">إجمالي الإيرادات</p>
                <p className="text-2xl font-black text-green-600">
                  {totalRevenue.toFixed(3)} <span className="text-sm font-bold">ر.ع</span>
                </p>
              </div>
            </div>
          </div>
            ...
            message={
              <div className="space-y-4" dir="rtl">
                ...
                <select
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-[#5C2E3A]/30 focus:border-[#5C2E3A] outline-none font-bold text-[#1F2937] bg-white"
                >
